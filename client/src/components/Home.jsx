    ...
    return (
        <div className='mt-[10rem] flex justify-between lg:flex-row flex-col pr-[5%] ml-[5%] md:ml-[20%] pr-[10%] lg:pr-[13%]' id='Home'>
            <div className='lg: max-w-[31rem]'>
                ...
                <p className='text-white/70 mt-5 text-xl'>I have experience of building applications.<br></br> Currently I love to work on web applications using technologies like React, Tailwind, Node and MongoDB.</p>
